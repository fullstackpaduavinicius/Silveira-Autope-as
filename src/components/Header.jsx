...
const Header = () => {
  ...
  return (
    <>
      ...
      <header className="bg-azulConfianca text-brancoTecnico shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-6">
              ...
              <li className="relative group">
                <button className="hover:text-prataProfissional transition flex items-center">
              ...
              <li><Link to="/trabalheconosco" className="text-amareloOferta font-semibold hover:text-amareloOferta/80">Trabalhe Conosco</Link></li>
            </ul>
          </nav>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="hidden md:flex items-center space-x-1 bg-vermelhoVibrante hover:bg-vermelhoSombra px-3 py-1 rounded-full transition"
            >
              ...
              <ul className="flex flex-col space-y-3">
                ...
                <li>
                  <button
                    ...
                    className="block py-2 hover:text-prataProfissional transition flex items-center w-full text-left"
                  >
                ...
                <li>
                  <Link 
                    to="/trabalheconosco" 
                    className="block py-2 text-amareloOferta font-semibold hover:text-amareloOferta/80 transition"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Trabalhe Conosco
                  </Link>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-6xl sm:w-full">
              <div className="bg-white">
                ...
                <div className="flex justify-between items-center border-b border-gray-200 p-4">
                  <h3 className="text-2xl font-bold text-azulConfianca">Nossa Localização</h3>
                  <button
                    onClick={toggleLocationModal}
                ...
                <div className="p-4">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 mb-2">
                              <a href="tel:+5579998354485" className="hover:text-azulConfianca transition">(79) 99835-4485</a>
                            </p>
                            <a 
                      ...
                      {/* Destaque */}
                      <div className="bg-azulConfianca text-white p-5 rounded-lg flex items-start">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg h-full">
                      ...
                      <div className="mt-3 flex justify-between items-center text-sm">
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="text-azulConfianca hover:text-azulConfianca/80 flex items-center transition"
                        >
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    onClick={toggleLocationModal}
                    className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-azulConfianca text-base font-medium text-white hover:bg-azulConfianca/90 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm"
                  >
                    Fechar
                  </button>
                </div>
